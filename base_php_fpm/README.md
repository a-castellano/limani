...
Packages installed:
- php8.3-cli (8.3.6-0ubuntu0.24.04.8)
- php8.3-curl (8.3.6-0ubuntu0.24.04.8)
- php8.3-gmp (8.3.6-0ubuntu0.24.04.8)
- php8.3-bcmath (8.3.6-0ubuntu0.24.04.8)
- php8.3-zip (8.3.6-0ubuntu0.24.04.8)
- php8.3-mysql (8.3.6-0ubuntu0.24.04.8)
- php8.3-imagick (3.7.0-4ubuntu3)
- php8.3-xml (8.3.6-0ubuntu0.24.04.8)
- php8.3-gd (8.3.6-0ubuntu0.24.04.8)
- php8.3-mbstring (8.3.6-0ubuntu0.24.04.8)
- php8.3-opcache (8.3.6-0ubuntu0.24.04.8)
- php8.3-igbinary (3.2.13-1ubuntu3)
- php8.3-bz2 (8.3.6-0ubuntu0.24.04.8)
- php8.3-fpm (8.3.6-0ubuntu0.24.04.8)
- php8.3-intl (8.3.6-0ubuntu0.24.04.8)
- php8.3-pgsql (8.3.6-0ubuntu0.24.04.8)
